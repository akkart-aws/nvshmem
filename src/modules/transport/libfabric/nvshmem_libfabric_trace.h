...
LTTNG_UST_TRACEPOINT_EVENT(nvshmem_libfabric, sender_completion,
...
LTTNG_UST_TRACEPOINT_EVENT(nvshmem_libfabric, sender_completion_ack,
    LTTNG_UST_TP_ARGS(int, domain_index, uint64_t, addr, int, ack_type),
    LTTNG_UST_TP_FIELDS(
        lttng_ust_field_integer(int, domain_index, domain_index)
...
LTTNG_UST_TRACEPOINT_EVENT(nvshmem_libfabric, receiver_completion_remote,
    LTTNG_UST_TP_ARGS(int, domain_index, uint64_t, addr, int, remote_type),
    LTTNG_UST_TP_FIELDS(
        lttng_ust_field_integer(int, domain_index, domain_index)
        lttng_ust_field_integer(uint64_t, addr, addr)
        lttng_ust_field_integer(int, remote_type, remote_type)
    )
)
...
LTTNG_UST_TRACEPOINT_EVENT(nvshmem_libfabric, receiver_completion,
    LTTNG_UST_TP_ARGS(int, domain_index, uint64_t, wr_id, int, type),
    LTTNG_UST_TP_FIELDS(
        lttng_ust_field_integer(int, domain_index, domain_index)
        lttng_ust_field_integer(uint64_t, wr_id, wr_id)
